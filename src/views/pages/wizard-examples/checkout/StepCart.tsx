    ...
    <Grid container spacing={6}>
      <Grid size={{ xs: 12, lg: 8 }} className='flex flex-col gap-4'>
        ...
        <div className='border rounded'>
          {products.map((product, index) => (
            ...
            >
              ...
              <IconButton size='small' className='absolute block-start-3 inline-end-3'>
                <i className='ri-close-line text-lg' />
              </IconButton>
              <div className='flex flex-col sm:flex-row items-center sm:justify-between gap-4 is-full'>
                <div className='flex flex-col gap-2 items-center sm:items-start'>
                  ...
                  <Rating
                    ...
                    emptyIcon={<i className='ri-star-fill text-textDisabled' />}
                    readOnly
                  />
        ...
        <Typography
          ...
          className='flex items-center font-medium justify-between gap-4 plb-[7px] pli-5 border border-primary rounded-lg'
          color='primary.main'
        >
          Add more products from wishlist
          <DirectionalIcon ltrIconClass='ri-arrow-right-line' rtlIconClass='ri-arrow-left-line' className='text-base' />
        </Typography>
      </Grid>
