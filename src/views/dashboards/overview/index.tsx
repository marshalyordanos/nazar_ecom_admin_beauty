...
import { useDashboardOverview, useDashboardPaymentSummary, useDashboardShopKpi, useDashboardSummaryWithDetails, useDashboardTopProducts } from '@/api/admin/dashboard'
  ...
  return (
    <Grid container spacing={6}>
      ...
      <Grid size={{ xs: 12, md: 7 }}>
        ...
        <Typography className='mb-2' variant='subtitle1'>
          Latest customer purchases with status and totals.
        </Typography>
