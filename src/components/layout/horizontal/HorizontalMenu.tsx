    ...
    >
      ...
      >
        <SubMenu label={dictionary['navigation'].dashboards} icon={<i className='ri-home-smile-line' />}>
          <MenuItem href={`/${locale}/dashboards/overview`} icon={<i className='ri-pie-chart-2-line' />}>
        ...
        <SubMenu label={dictionary['navigation'].apps} icon={<i className='ri-mail-open-line' />}>
          <SubMenu label={dictionary['navigation'].eCommerce} icon={<i className='ri-shopping-bag-3-line' />}>
            ...
            <SubMenu label={dictionary['navigation'].products}>
              ...
              <MenuItem href={`/${locale}/apps/ecommerce/products/options`}>
            ...
            <MenuItem href={`/${locale}/apps/ecommerce/store-settings`} icon={<i className='ri-store-2-line' />}>
              Store profile
            </MenuItem>
          </SubMenu>
          <MenuItem href={`/${locale}/apps/system/maintenance`} icon={<i className='ri-tools-line' />}>
            Maintenance mode
          </MenuItem>
